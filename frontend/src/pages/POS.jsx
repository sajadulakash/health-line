                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ padding: '14px 14px 12px', flex: 1, display: 'flex', flexDirection: 'column', gap: 4 }}>
                      ...
                      {p.packaging_details && <div style={{ fontSize: '0.78rem', color: '#64748b' }}><span style={{ fontWeight: 600 }}>Packaging Details:</span><div style={{ whiteSpace: 'pre-line' }}>{p.packaging_details}</div></div>}
                      {p.category && (
